...
public final class SomeInterfaceClassClassLoaderUtils {
    ...
    static {
        ...
        final ClassLoader classLoader = SomeInterface.class.getClassLoader();

        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug("*** Will perform class resolution using the CLASS (SomeInterface.class) CLASS LOADER ***");
    ...
    private SomeInterfaceClassClassLoaderUtils() {
        super();
    }
