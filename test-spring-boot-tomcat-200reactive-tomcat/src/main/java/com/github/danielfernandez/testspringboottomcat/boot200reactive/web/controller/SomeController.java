 ...
 * =============================================================================
 */
package com.github.danielfernandez.testspringboottomcat.boot200reactive.web.controller;
...
public class SomeController {
    ...
    public String threadContext() {
        ...
        final String message =
                String.format(
                        "THREAD CONTEXT | Spring Boot: %s | Spring Web Reactive: %s | Output: %s",
    ...
    public String clazz() {
        ...
        final String message =
                String.format(
                        "CLASS | Spring Boot: %s | Spring Web Reactive: %s | Output: %s",
                        SpringBootVersion.getVersion(), SpringVersion.getVersion(), output);
        return message;
    }
